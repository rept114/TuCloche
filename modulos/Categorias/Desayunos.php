<?php
require_once '../../appCode/clsProductos.php';
?>
            ...
            foreach($result as $index => $row) {
                ...
                <div class="col">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <h5 class="card-title" id="nombreProducto<?=$index?>"><?=$row["nombre_productos"]?></h5>
                            <p class="card-text"><?=$row["descripcion_productos"]?></p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div style="font-size: 22px;" id="precioProducto<?=$index?>">$<?=$row["precio_productos"]?></div>
                                <button class="btn btn-sm" style="width: 50px; height: 50px;" onclick="insertarEnBaseDeDatos(<?=$index?>);">
